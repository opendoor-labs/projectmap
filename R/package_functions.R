...
#' @author Alex Hubbard (hubbard.alex@gmail.com)
#' @export
get_file_path = function(file, inFolder = NULL, recall = T, allowMult = F, full = F, proj.env = get("proj.env", envir = environment())){
...
#' @author Alex Hubbard (hubbard.alex@gmail.com)
#' @export
get_file_folder = function(file, inFolder = NULL, recall = T, allowMult = F, proj.env = get("proj.env", envir = environment())){
...
#' @author Alex Hubbard (hubbard.alex@gmail.com)
#' @export
get_output_dir = function(doc = F, file = NULL, inFolder = NULL, proj.env = get("proj.env", envir = environment())){
...
#' @author Alex Hubbard (hubbard.alex@gmail.com)
#' @export
read_file = function(file, inFolder = NULL, showProgress = F, proj.env = get("proj.env", envir = environment()),
...
save_file = function(..., file = NULL, file.override = NULL, row.names = F, showProgress = F, paper = "USr", combine = F,
                ...
                append = F, plot = last_plot(), doc = F, envir = parent.frame(), proj.env = get("proj.env", envir = environment())){
