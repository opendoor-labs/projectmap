...
```{r, echo = T, eval = F}
devtools::install_github("opendoor-labs/projectmap", auth_token = "TOKEN")
```
You will need to get the auth_token from Opendoor's 1password vault. Search for "github opendoor-labs/projectmap auth_token" in 1password to find the auth_token.
